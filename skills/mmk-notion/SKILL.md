...
|-------------|-------------|-------|
| `page` | Invite, revoke, publish, unpublish, config, publish-settings, duplicate, list-published, markdown (get/create/append/replace/update), transcript, get, update, update-markdown [deprecated] (17 commands) | [`mmk-notion-page`](../mmk-notion-page/SKILL.md) |
...
| `database` | Schema, query, insert, update, upsert, check-duplicates, delete, AI summary, AI summary auto (9 commands) | [`mmk-notion-database`](../mmk-notion-database/SKILL.md) |
