...
|-------------|-------------|-------|
| `file` | List/inspect recordings, get audio URL, download, rename, organize into folders, fetch transcripts/summaries, list/get content tabs, trigger auto transcript+summary, trash notes (12 commands) | [`mmk-plaud-file`](../mmk-plaud-file/SKILL.md) |
